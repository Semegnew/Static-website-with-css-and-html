...
if (isset($_GET['SetNonrenewed'])) {
  $query = "UPDATE rg SET renewed='NonRenewed'";
...
<div class="collapse navbar-collapse" id="navbarNavDropdown">
  <ul class="navbar-nav ">
    ...
    <div class="lang">
      <input type="button" onclick="location.href='Admin_Set_Expire_License.php?lang=en';" value="<?php echo $lang['lang_en'] ?>" />

      <input type="button" onclick="location.href='Admin_Set_Expire_License.php?lang=amha';" value="<?php echo $lang['lang_amha'] ?>" />
  ...
  <div class="container-fluid" style="padding:0px;">
    <div class="container-fluid bg-success text-white">
      <h1 class="display-4"> Set Expired Trade License
        <div style=" float:right">
          <a href="Admin_Set_Expire_License.php?SetNonrenewed=" onclick="return confirm('Are you sure you want to Expired All License?');" role="button" class="btn btn-danger"> Set Expired </a>
          <a href="Admin_Set_Expire_License.php?SetNonrenewed=" onclick="return confirm('Are you sure you want to Renewed All Customer Licence?');" role="button" class="btn btn-primary">Set Renewed </a>
        </div>
      </h1>
    </div>
    ...
    <table class="table table-dark">
      ...
      <?php
      $tbl = mysqli_query($conn_reg, "SELECT *FROM rg WHERE renewed ='renewed';")
