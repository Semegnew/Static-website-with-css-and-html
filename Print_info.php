...
url(gonder-3.jpg)no-repeat center center fixed;background-size:cover;">
     ...
     <nav class="navbar-custom">
          ...
          <?php } ?>
          <div class="lang">
               <input type="button" onclick="location.href='Print_info.php?lang=en';" value="<?php echo $lang['lang_en'] ?>" />
               <input type="button" onclick="location.href='Print_info.php?lang=amha';" value="<?php echo $lang['lang_amha'] ?>" />
          </div>
     </nav>
     ...
     <div style="background-color: black; float:right">
